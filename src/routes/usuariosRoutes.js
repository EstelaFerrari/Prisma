...
router
  ...
  .get("/totas/:id", UsuarioController.listarUsuarioPorId)
  .post("/usuarios", UsuarioController.cadastrarUsuario)
  .patch("/totas/:id", UsuarioController.PATCHAtualizarUsuario)
  .delete("/totas/:id", UsuarioController.excluirUsuario)
