...
class UsuariosGruposController {
  ...
  // GET por ID - Listar Grupo de Usuarios por ID
  ...
  // POST - Cadastrar Grupo de Usuarios
  ...
  // PATCH - Atualizar Grupo de Usuarios por ID
  ...
  // DELETE - Excluir Grupo de Usuarios por ID
